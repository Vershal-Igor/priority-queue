  ...
  remove() {
     ...
     */
		if(this.parent) {
            ...
            //Кэшируем линки на left/right для childNode и для parentNode
			var tmp_child = {
				left: childNode.left,
			...
			console.log(tmp_child);

            // "Смотрим" на уровень выше - если у parentNode был свой Parent, надо в нём сменить указатель на childNode.
			if(grandNode){
